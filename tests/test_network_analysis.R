...
stopifnot(file.exists(file.path(job_dir, "figures", "network_centrality.png")))
stopifnot(file.exists(file.path(job_dir, "figures", "network_edge_composition.png")))
stopifnot(file.exists(file.path(job_dir, "figures", "network_figure_combined.png")))
stopifnot(file.exists(file.path(job_dir, "figures", "network_figure_combined.pdf")))
stopifnot(file.exists(file.path(job_dir, "figures", "network_figure_combined.svg")))
stopifnot(file.exists(file.path(job_dir, "figures", "network_figure_combined.tiff")))
